...
@section('content')
    <!-- Banner
    ================================================== -->
    <div id="banner" class="with-transparent-header parallax background" style="background-image: url({{ asset('bower_components/bower-firstjob/frontend/images/banner-home-02.jpg)') }}" data-img-width="2000" data-img-height="1330" data-diff="300">
        <div class="container">
            ...
            <div class="listings-container">
                ...
                <a href="job-page-alt.html" class="listing full-time">
                    <div class="listing-logo">
                        <img src="{{ asset('bower_components/bower-firstjob/frontend/images/job-list-logo-01.png') }}" alt="">
                    </div>
                ...
                <a href="job-page.html" class="listing part-time">
                    <div class="listing-logo">
                        <img src="{{ asset('bower_components/bower-firstjob/frontend/images/job-list-logo-02.png') }}" alt="">
                    </div>
                    <div class="listing-title">
                ...
                <a href="job-page.html" class="listing internship">
                    <div class="listing-logo">
                        <img src="{{ asset('bower_components/bower-firstjob/frontend/images/job-list-logo-04.png') }}" alt="">
                    </div>
                    <div class="listing-title">
                ...
                <a href="job-page.html" class="listing freelance">
                    <div class="listing-logo">
                        <img src="{{ asset('bower_components/bower-firstjob/frontend/images/job-list-logo-05.png') }}" alt="">
                    </div>
                    <div class="listing-title">
            ...
            <div class="testimonial-carousel testimonials">
                ...
                <div class="fw-carousel-review">
                    ...
                    <div class="testimonial-author">
                        <img src="{{ asset('bower_components/bower-firstjob/frontend/images/resumes-list-avatar-03.png') }}" alt="">
                ...
                <div class="fw-carousel-review">
                    ...
                    <div class="testimonial-author">
                        <img src="{{ asset('bower_components/bower-firstjob/frontend/images/resumes-list-avatar-02.png') }}" alt="">
                ...
                <div class="fw-carousel-review">
                    ...
                    <div class="testimonial-author">
                        <img src="{{ asset('bower_components/bower-firstjob/frontend/images/resumes-list-avatar-01.png') }}" alt="">
